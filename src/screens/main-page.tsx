    ...
    await UserService.getAllTransactions(token, 'month')
      .then((res) => {
        if (res.data.error) {
          ...
          navigation.navigate('PlaidConnection', { name: 'Jane' });
        }
        else {
      ...
      <View style={scrollingDraw ? { display: 'none' } : { zIndex: 1, elevation: 1, position: 'absolute' }}>
        ...
        <View style={{ width: '100%', display: 'flex', justifyContent: 'center', margin: 'auto', height: 340, marginBottom: 0, paddingBottom: 0 }}>
          <View style={{ display: 'flex', marginBottom: 0, paddingBottom: 0, top: 20 }}>
            ...
            <Charts data={getAmountSpentPerAmount(transactions)} labels={['Less than £5', '£5-£10', '£10-£20', '£20-£30', '£30+']} type='pie' />
          </View>
        </View>
...
//   if (!transactions.length) return <LoadingContainer><Text>Loading...</Text></LoadingContainer>;

//   return (
//     <MainContainer>
//       <LoadingContainer style={scrollingDraw ? { display: 'none' } : {}}>
//         <Spinner
//           visible={showLoadingSpinner}
//           textContent={'Loading...'}
//           textStyle={styles.spinnerTextStyle}
//           overlayColor={'rgba(00, 0, 0, 0.6)'}
//         />
//         <LoadingText>Transactions</LoadingText>
//         <ChartsContainer>
